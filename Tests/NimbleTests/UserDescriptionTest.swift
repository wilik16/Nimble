...
final class UserDescriptionTest: XCTestCase {
    func testToMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).to(NimblePredicate.simple { _ in .doesNotMatch }, description: "These aren't equal!")
        }
    }
    ...
    func testNotToMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).notTo(NimblePredicate.simple { _ in .matches }, description: "These aren't equal!")
        }
    }
    ...
    func testToNotMatcher_CustomFailureMessage() {
        failsWithErrorMessage(
            ...
            expect(1).toNot(NimblePredicate.simple { _ in .matches }, description: "These aren't equal!")
        }
    }
