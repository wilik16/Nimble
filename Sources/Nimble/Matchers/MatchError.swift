...
public func matchError<T: Error>(_ error: T) -> NimblePredicate<Error> {
...
public func matchError<T: Error & Equatable>(_ error: T) -> NimblePredicate<Error> {
    return NimblePredicate.define { actualExpression in
        let actualError = try actualExpression.evaluate()
...
public func matchError<T: Error>(_ errorType: T.Type) -> NimblePredicate<Error> {
    return NimblePredicate.define { actualExpression in
        let actualError = try actualExpression.evaluate()
